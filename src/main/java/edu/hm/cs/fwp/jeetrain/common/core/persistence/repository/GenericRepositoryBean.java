...
public class GenericRepositoryBean {
	...
	/**
	 * Fügt die angegebene Entität in den Datastore ein und synchronisiert diese mit
	 * datastore-seitig generierten beziehungsweise veränderten Feldern.
	 * 
	 * @param entity
