...
public class FlowConfigBean {
	 ...
	 * <p>Defaults to {@link FlowConfigBean#beanName}.</p>
	 */
	private String name;
	 ...
	 * <ul>
	 * <li><code>false</code> means that the view ID that triggered the activation of the flow is always used as redirect URLs regardless which view ID the current state has.</li>  
	 * <li><code>true</code> means that the view ID of the current state is used as redirect URL.</li>
	 * </ul>
